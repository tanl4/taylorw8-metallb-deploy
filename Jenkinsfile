pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/tanl4/taylorw8-metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('tanl4-225')   // <---- Change this to match your kubernetes cluster credentials
    }
